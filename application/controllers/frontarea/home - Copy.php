...
class Home extends CI_Controller {
	...
	{
		$data['title'] = "Biriyani Hut | Toowoomba's First South Indua Restaurant"; 
		...
		$mapconfig['center']=$this->config->item('center');
		$mapconfig['map_height']=$this->config->item('map_height');
		$mapconfig['streetViewControl']=$this->config->item('streetViewControl');
	...
	{
		$data['title'] = "Biriyani Hut | Toowoomba's First South Indua Restaurant | Menu"; 
		$data['meta'] = "Biriyani Hut | Toowoomba's First South Indua Restaurant";
		$data['keywords'] = "toowoomba, south indian, restaurant, food, dishes";
	...
	{
		$data['title'] = "Biriyani Hut | Toowoomba's First South Indua Restaurant | About Us"; 
		$data['meta'] = "Biriyani Hut | Toowoomba's First South Indua Restaurant";
		$data['keywords'] = "toowoomba, south indian, restaurant, food, dishes";
