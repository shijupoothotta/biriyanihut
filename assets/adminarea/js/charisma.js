$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','bassets/css/bootstrap-'+theme_name+'.css');
	}*/
	...
	$('a.ajax-link').click(function(e){
		...
		document.title = "Biriyani Hut | Biriyani Hut | Toowoomba's First South Indua Restaurant";
	});
...
function docReady(){
	...
	//datepicker
	$('.datepicker').datepicker({changeMonth: true,changeYear: true,dateFormat: "dd-mm-yy",altFormat: "yy-mm-dd"});
