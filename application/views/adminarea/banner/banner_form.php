...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Add / Edit banner</h2>
            <div class="box-icon">
        ...
        <?php   
            ...
            echo form_open_multipart('adminbanner/save', $attributes); 
        ?>
            <fieldset>
            ...
            <div class="control-group <?php echo form_error('c_title') ? 'error' : '' ?>">
                <label for="c_title" class="control-label">Banner Title <span class="required">*</span></label>
                <div class="controls">
                <?php 
            ...
            <div class="row-fluid">
                <div class="span10 well center">
                	For Best Results Image Should Be of:- Height: 500px | Width: 455px | Maximum File Size 1024 kb 
                </div>
            </div>                                      
			<?php if($id && $c_image != ''):?>
            <div class="row-fluid">
                <div class="span10 well center">
                	<img src="<?php echo base_url('uploads/images/slider/'.$c_image);?>" alt="current"/><br/>
                </div>
            </div>
            <?php endif;?>              
            <div class="form-actions">
                ...
                <button type="reset" class="btn ajax-link" 
                    onclick="document.location.href='<?php echo base_url()?>adminbanner';">
                    Cancel
                </button>
            </div>
